      ...
      <div className="premium-container">
        ...
        {isLoading ? (
          ...
          <div className="premium-grid animate-fade-in-premium">
            {premiumData.map((pkg) => {
              const convertedPrice = pkg.price * exchangeRates[currency];
              return (
                <div key={pkg.id} className="premium-card">
                  ...
                  <div className="card-content">
                    ...
                    <div className="inclusions-row">
                      ...
                      {pkg.inclusions.includes("Transport") && (
                        <div className="inclusion-box">
                    ...
                    <div className="distance-info-box">
                      <div className="dist-row">
                        ...
                        <span className="dist-val">{pkg.distances.makkah}</span>
                      </div>
                      <div className="dist-row">
                        <span className="dist-label">Madinah Distance:</span>
                        <span className="dist-val">{pkg.distances.madinah}</span>
                      </div>
                    </div>
                    ...
                    <div className="card-bottom-flex">
                      ...
                      <Link to={`/?pkg=${pkg.id}`} className="premium-book-btn">Book Now</Link>
                    </div>
                  </div>
                </div>
              );
