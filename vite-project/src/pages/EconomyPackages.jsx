...
import './EconomyPackages.css'; // 👈 CSS Import zaroor check kar lein
        ...
        {isLoading ? (
          ...
          <div className="eco-grid animate-fade-in">
            {economyData.map((pkg) => {
              ...
              const convertedPrice = pkg.price * rate;
                  ...
                  <div className="eco-card-content">
                    ...
                    <div className="eco-distance-box">
                      <div className="eco-dist-row">
                        ...
                        <span className="eco-dist-val">{pkg.distances.makkah}</span>
                      </div>
                      <div className="eco-dist-row">
                        <span className="eco-dist-label">Madinah Distance:</span>
                        <span className="eco-dist-val">{pkg.distances.madinah}</span>
                      </div>
                    </div>
                    ...
                    <div className="eco-card-footer">
                      ...
                      <Link to={`/?pkg=${pkg.id}`} className="eco-btn-view">View Details</Link>
                    </div>
